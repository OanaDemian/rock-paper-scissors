...
describe("Rock Paper Scissors Game Tests", () => {
  it(`returns draw when players make the same choice`, () => {
    ...
    //assert
    expect(rockPaperScissors.lastGame).to.equal(
      `${playerOne} and ${playerTwo} both played ${choice}. It's a draw!`,
    );
  });
  ...
  it(`checks that playerOne wins when playerOneChoice is rock and playerTwoChoice is scissors.`, () => {
    ...
    //assert
    expect(rockPaperScissors.lastGame).to.equal(
      `${playerOne} played ${playerOneChoice}. ${playerTwo} played ${playerTwoChoice}. ${playerOne} wins.`,
    );
  });
  ...
  it(`checks that playerOne looses when playerOneChoice is rock and playerTwoChoice is paper.`, () => {
    ...
    //assert
    expect(rockPaperScissors.lastGame).to.equal(
      `${playerOne} played ${playerOneChoice}. ${playerTwo} played ${playerTwoChoice}. ${playerTwo} wins.`,
    );
  });
  ...
  it(`returns an error if playerOneChoice is not rock, paper or scissors.`, () => {
    ...
    expect(() =>
      rockPaperScissors.game(playerOneChoice, playerTwoChoice),
    ).to.throw(`${playerOneChoice} must be a valid choice.`);
  });
  ...
  it(`returns an error if playerTwoChoice is not rock, paper or scissors.`, () => {
    ...
    expect(() =>
      rockPaperScissors.game(playerOneChoice, playerTwoChoice),
    ).to.throw(`${playerTwoChoice} must be a valid choice.`);
  });
  ...
  it(`returns an error if player names are undefined.`, () => {
    ...
    expect(() =>
      rockPaperScissors.game(playerOneChoice, playerTwoChoice),
    ).to.throw(`Players must register their names.`);
  });
});
